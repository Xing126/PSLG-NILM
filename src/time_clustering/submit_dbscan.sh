...
#SBATCH -o ./cluster_data/slurm_log/job-%x-%j.out # 标准输出日志，%j会被替换为作业ID
#SBATCH -e ./cluster_data/slurm_log/job-%x-%j.err # 标准错误日志
...
conda activate dbscan_env # <--- 修改为你的Conda环境名
